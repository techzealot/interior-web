...
const Testimonial = () => {
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      <div className="flex w-full flex-col items-stretch justify-between gap-8 bg-black px-10 py-10 md:flex-row">
        {testimonials.map((item) => (
          <div
            className="my-container group flex flex-col items-start gap-4 border border-gray-500 p-10 text-gray-500 hover:bg-white"
            key={item.id}
          >
